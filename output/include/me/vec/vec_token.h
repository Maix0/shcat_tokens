...
/// @param capacity The capacity of the new vec_token (in terms of elements)
/// @param free_function The function that will be used to free the elements of the vec_token
...
/// @brief Get the last element from the vec_token, and remove it from the vec_token
...
/// @brief Get the first element from the vec_token, and remove it from the vec_token
/// @param vec The vec_token to get the element from
...
/// @brief Run the function on every element of the vec_token and returns if all elements returned true
/// @param vec The vec_token to search in
/// @param fn The function to run on each element
...
/// @brief Run the function on every element of the vec_token and returns if any element returned true
/// @param vec The vec_token to search in
/// @param fn The function to run on each element
/// @param[out] result The result of the operation
/// @return true if the operation failed, false otherwise
